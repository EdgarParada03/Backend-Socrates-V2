...
public class Servicio {
    ...
    public Servicio(long id, LocalDate fechaServicio, String descripcion, LocalTime horaServicio, String estado, TipoPlan tipoPlan, Empleado tecnico, LocalDate fechaRegistro) {
        this.id = id;
